...
export const homePage: PageContent = {
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          summary: "Solo park-and-switch rhythm, box pressure-plate holds, and diamond order.",
          href: "/forest-temple-chapter-walkthrough/",
        },
        {
          title: "Achievements",
  ...
  faqIds: ["release-date", "steam-vs-flash", "controls-coop", "browser-mirrors", "remote-play-together"],
  relatedPageIds: [
    "release-platforms",
